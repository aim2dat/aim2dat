...
def test_read_phonopy_thermal_properties(nested_dict_comparison):
    ...
    nested_dict_comparison(thermal_properties, thermal_properties_ref, threshold=1000.0)
...
def test_read_phonopy_qha_properties(nested_dict_comparison):
    ...
    nested_dict_comparison(qha_properties, qha_properties_ref, threshold=1000.0)
