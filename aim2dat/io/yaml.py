...
def load_yaml_file(file_path: str, typ: str = "safe"):
    ...
    Notes
    -----
        This function is deprecated and will be removed, please use `read_yaml_file` instead.
    ...
    warn(
        "This function will be removed, please use `read_yaml_file` instead.",
        DeprecationWarning,
        2,
    )
...
def store_in_yaml_file(file_name: str, content: Any):
    ...
    Notes
    -----
        This function is deprecated and will be removed, please use `write_yaml_file` instead.
    ...
    warn(
        "This function will be removed, please use `write_yaml_file` instead.",
        DeprecationWarning,
        2,
    )
